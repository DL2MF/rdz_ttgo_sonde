...
const char *createQRGForm() {
  char *ptr = message;
  strcpy(ptr, "<html><head><link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\"></head><body><form action=\"qrg.html\" method=\"post\"><table class=\"data\"><thead><tr><th class=\"rowID\">ID</th><th class=\"rowAct\">Active</th><th class=\"rowFreq\">Freq</th><th class=\"rowSite\">Launchsite</th><th class=\"rowType\">Mode</th></tr></thead><tbody>");
  for (int i = 0; i < sonde.config.maxsonde; i++) {
    ...
    sprintf(ptr + strlen(ptr), "<tr><td>%d</td><td><input name=\"A%d\" type=\"checkbox\" %s/></td>"
            "<td class=\"rowFreq\"><input name=\"F%d\" type=\"text\" size=\"10\" value=\"%3.3f\"></td>"
            "<td class=\"rowSite\"><input name=\"S%d\" type=\"text\" size=\"16\" value=\"%s\"></td>"
  ...
  strcat(ptr, "</tbody></table><input type=\"submit\" value=\"Update\"/></form></body></html>");
  return message;
}
